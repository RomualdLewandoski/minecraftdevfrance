 ...
 */
final class Version20200806123854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9D40DE1B1C0BE183 ON topic (solution_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_9D40DE1B1C0BE183 ON topic');
